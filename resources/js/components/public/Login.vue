<template>
    <div class="login-container">
        <div class="card shadow">
            <div class="card-body">
                <router-link class="btn btn-sm btn-light" :to="{name: 'Home'}"><i class="far fa-arrow-left"></i> Home</router-link>
                <div class="text-center"><img :src="'/images/Logo.png'" alt="Logo" width="150"></div>
                <h2 class="text-center"><strong>DOST-SEI</strong></h2>
                <h2 class="text-center mt-2">Project Management Information System</h2>
                <div class="d-flex justify-content-center">
                    <div class="card w-100 mt-4">
                            <div class="card-body">
                                <p class="text-success font-weight-bold">Sign in here!</p>
